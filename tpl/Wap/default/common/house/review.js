...
FCAPP.REVIEW = FCAPP.REVIEW || {
    ...
    loadReviewList: function() {
        ...
        $.ajax({
            url: '/index.php?g=Wap&m=Index&a=impressdata&iMicms=mp.weixin.qq.com&token='+token,
            dataType: 'jsonp'
        });
    },
    ...
    sendReview: function() {
        ...
        if (isNaN(id) || review.length != 4 || /[^\u4e00-\u9FFF]/g.test(review)) {
            ...
            $.ajax({
                url: '/index.php?g=Wap&m=Index&a=getdata?'+$.param(data),
                dataType: 'jsonp'
            });
        }
    },
    ...
    loadProList: function() {
        ...
        $.ajax({
             url: '/index.php?g=Wap&m=Index&a=reviewdata&iMicms=mp.weixin.qq.com&token='+token,
            dataType: "jsonp",
