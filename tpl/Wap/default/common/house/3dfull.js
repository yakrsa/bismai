...
FCAPP.HOUSE.FULL3D = {
    ...
    init: function() {
        ...
        window.shareData.linkKeep = '/index.php?g=Wap&m=Index&a=hxdata&iMicms=mp.weixin.qq.com&token='+token;
    ...
    loadData: function() {
        ...
        $.ajax({
            ...
            url: '/index.php?g=Wap&m=Index&a=hxdata&iMicms=mp.weixin.qq.com&token='+token,
            dataType: 'jsonp',
            error: function() {
                FCAPP.Common.msg(true, {
                    msg: '无效的户型！'
