...
return  array(
    ...
    'APP_GROUP_LIST'        => 'Home,Admin,User,Wap,Chat,Wxshop,Wxadmin',      // 项目分组设定,多个组之间用逗号分隔,例如'Home,Admin'
    ...
    /* 数据库设置 */
    'DB_TYPE'               => 'mysql',     // 数据库类型
    'DB_HOST'               => 'zhaomingyuinter.mysql.rds.aliyuncs.com', // 服务器地址
    'DB_NAME'               => 'wgc',          // 数据库名
    'DB_USER'               => 'appuser',      // 用户名
    'DB_PWD'                => 'weixinshop',          // 密码
    'DB_PORT'               => '',        // 端口
