            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="box">
                        <div class="box-title">
                            <div class="span8">
                                <h3><i class="icon-table"></i>桌台管理</h3>
                            </div>
...
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Product/tableAdd',array('token'=>$token,'dining'=>$isDining));?>" title="" class="btn"><i class="icon-plus"></i>添加桌台</a></div>
<div class="clr"></div>
</div>
