            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="box">
                        ...
                        <div class="box-content">
                            ...
                            <div class="row-fluid dataTables_wrapper">
                                <form action="<?php echo U('Diymen/upsaves');?>" method="post" class="form-horizontal form-validate"  enctype="multipart/form-data">
					...
					<?php if(is_array($class)): $i = 0; $__LIST__ = $class;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$class): $mod = ($i % 2 );++$i;?><tr class="ptr">
                                            <td>
                                                <input type="text" class="input-mini" size="3" value="<?php echo ($class["sort"]); ?>" name="ps[<?php echo ($class["id"]); ?>][sort]"   data-rule-number="true"/></td>
                                            <td>
                                                <input type="text" class="input-medium" size="15" value="<?php echo ($class["title"]); ?>"  name="ps[<?php echo ($class["id"]); ?>][title]" data-rule-required="true" data-rule-maxlength="30" />
												<i class="icon-plus cursor_p add" title="添加子菜单" rel="<?php echo ($class["id"]); ?>"></i>
                                            </td>
                                            <td>
                                                <input type="text" class="input-medium type" size="15" value="<?php echo ($class["keyword"]); ?>"  name="ps[<?php echo ($class["id"]); ?>][keyword]" data-rule-required="true" data-rule-maxlength="200" />
                                            ...
                                            <td><a href="javascript:G.ui.tips.confirm('您确定要删除此菜单吗?', '<?php echo C('site_url'); echo U('Diymen/class_del',array('id'=>$class['id']));?>');">删除</a></td>
                                        </tr>
					 ...
					 <?php if(is_array($class['class'])): $i = 0; $__LIST__ = $class['class'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$class1): $mod = ($i % 2 );++$i;?><tr class="ztr">
                                            <td>
                                                <input type="text" class="input-mini" size="3" value="<?php echo ($class1["sort"]); ?>" name="ps[<?php echo ($class1["id"]); ?>][sort]"   data-rule-number="true"/></td>
                                            <td>
												<i class='board'></i>
                                                <input type="text" class="input-medium" size="15" value="<?php echo ($class1["title"]); ?>"  name="ps[<?php echo ($class1["id"]); ?>][title]" data-rule-required="true" data-rule-maxlength="30" />

                                            </td>
                                            <td>
                                                <input type="text" class="input-medium type" size="15" value="<?php echo ($class1["keyword"]); ?>"  name="ps[<?php echo ($class1["id"]); ?>][keyword]" data-rule-required="true" data-rule-maxlength="200" />
                                            ...
                                            <td><a href="javascript:G.ui.tips.confirm('您确定要删除此菜单吗?', '<?php echo C('site_url'); echo U('Diymen/class_del',array('id'=>$class1['id']));?>');">删除</a></td>
