            ...
            if (!$prizedCount < $maxPrizeCount){
                ...
                if ($record['usenums'] >= $Lottery['canrqnums']){
                    ...
                    if ($Lottery['daynums'] && $thisDayNums >= $Lottery['daynums']){
                        ...
                        switch ($prizeType){
                        default: $data['prizetype'] = 7;
                            $data['zjl'] = 0;
                            $data['winprize'] = "谢谢参与";
                            $isLottery = 0;
                            $data['sncode'] = '';
                            break;
                        case 1: $data['prizetype'] = 1;
                            $data['sncode'] = uniqid();
...
default: return $prizetype;
    break;
case 1: return $Lottery['fist'];
    break;
case 2: return $Lottery['second'];
    break;
case 3: return $Lottery['third'];
    break;
case 4: return $Lottery['four'];
    break;
case 5: return $Lottery['five'];
    break;
case 6: return $Lottery['six'];
    break;
}
}
}
