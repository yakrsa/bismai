...
//参数设置
define('SOFT_VERSION', 'iMicms_V1.0');
define('SOFT_RELEASE', $version);
define('ROOT_PATH', dirname(__FILE__).'/../');//网站根目录
define('SOFT_NAME', '比斯迈微管家'.SOFT_VERSION);
define('DBCHARSET','UTF8');//编码 分为 UTF8 GBK
//----------------------语言包
$lang = array(
'license'=>'<div class="license"><h1>系统安装协议</h1>
                <p>版权所有 (c)2013-2014 比斯迈微管家保留所有权利。</p>
				<p>感谢您选择比斯迈微管家，微信公共平台基于 PHP + MySQL   的技术开发，全部源码开放。</p>
			...
			<strong>二、协议许可的权利 </strong>
				...
				<p>2、您可以在协议规定的约束和限制范围内修改比斯迈微管家多用户微信营销系统源代码或界面风格以适应您的网站要求。 </p>
			...
			<strong>三、协议规定的约束和限制 </strong>
				...
				<p>3、未经官方许可，禁止在比斯迈微管家多用户微信营销系统的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
				<p>4、如果您未能遵守本协议的条款，您的授权将被终止，所被许可的权利将被收回，并承担相应法律责任。 
				<p>5、比斯迈微管家网址(<a href="http://bbs.imicms.com" target="_blank">bbs.imicms.com</a>)</p>
				</p>
			<strong>四、有限担保和免责声明 </strong>
				...
				<p>3、电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始确认本协议并安装比斯迈微管家多用户微信营销系统，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</p>
				<p>4、如果本软件带有其它软件的整合API示范例子包，这些文件版权不属于本软件官方，并且这些文件是没经过授权发布的，请参考相关软件的使用许可合法的使用。</p>
				<p><b>版本最新更新：</b> 2014年05月12日</p>
                <p align=right>比斯迈微管家</p>
</div>',
'agreement_yes' => '我同意，继续安装',
'agreement_no' => '我不同意',
'title_install' => ' 比斯迈微管家多用户微信营销系统 安装程序',
...
'dbname' => '数据库名',
'tablepre' => '数据表前缀',
'tablepre_comment' => '默认imicms_请勿修改',
'dbport' =>'数据库端口',
'dbport_comment' => '默认数据库端口3306',
'tips_admininfo' => '网站信息',
'username' => '管理员账号',
'username_comment' => '使用默认admin，安装后自行修改',
'password' => '管理员密码',
'password_comment' => '使用默认imicms，安装后自行修改',
'password2' => '重复密码',
...
'install_succ_remark'=>'<p class=\'nest\'>请等待系统安装完成，切勿刷新...</p>
		<p class=\'nes\'>1.系统后台地址：<a href=\'http://'.$_SERVER['HTTP_HOST'].trim(str_replace(strstr($_SERVER['SCRIPT_NAME'], '/install'),"",$_SERVER['SCRIPT_NAME'])).'/imicms.php\' target=\'_blank\'>http://'.$_SERVER['HTTP_HOST'].trim(str_replace(strstr($_SERVER['SCRIPT_NAME'], '/install'),"",$_SERVER['SCRIPT_NAME'])).'/imicms.php</a></p>
...
if (file_exists('lock')){
	...
	echo "系统已经安装过了，如果要重新安装，请删除install目录下的lock文件";
	exit;
}
...
<meta content="比斯迈微管家、比斯迈微信" name="Copyright" />
...
?>
			<div class="footer">
			    <p>Powered by 比斯迈微管家多用户微信营销系统 V1.0 2013-2014</p>
				<p>版权所有</p>
			</div>
		</div>
		</div>
...
function config_edit() {
	...
	$str=file_get_contents("../Data/conf/Admin/config.php");
	$str=str_replace("'imicms'","'$username'",$str);
	file_put_contents("../Data/conf/Admin/config.php",$str);
...
function runquery($sql) {
	...
	$sql = str_replace("\r", "\n", str_replace('imicms_', $tablepre, $sql));
	$ret = array();
	$num = 0;
	foreach(explode(";\n", trim($sql)) as $query) {
		$ret[$num] = '';
